...
return [
	...
	$config->BBCodes->addCustom('[NSFW]{ANYTHING5}[/NSFW]', '<div class="cb-nsfw-alert"><i class="fas fa-exclamation-triangle" style="color:red"></i> <b>Cảnh báo:</b> Nội dung dưới đây có thể gây khó chịu với một số người. Cân nhắc trước khi nhấp vào để xem.</div> <div class="cb-nsfw-blur" onclick="if(this.className == \'cb-nsfw-blur\'){this.className = \'cb-nsfw-show\';} else {this.className = \'cb-nsfw-blur\';}">{ANYTHING5}</div>');
